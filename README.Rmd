...
So, the OLS estimate for the coefficent `beta_0` on the treatment variable `w` is aboud `r round(beta_0,2)`. Now we compute the hacking interval around this value with `hacking_lm`, allowing for a `theta = 0.5` percent change in the loss:
